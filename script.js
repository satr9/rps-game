...
function game() {
    ...
    let round;
    let roundcount = 1;
    // to make the loop go until either player reaches five points, the while loop keeps going through iterations until either user or computer reach 5 points. While user isn't 5 AND computer isn't 5, this loop keeps going. As soon as either one reaches 5 points, the loop's condition no longer evaluates to true (since we're checking that user isn't 5 == ture AND computer isn't 5 == true) and it breaks out of the loop.
